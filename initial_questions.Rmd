...
Yes, there 34 species unique to their USACE district. Four species (CARYA, NONE, OTH1, and UNK) are unique to Rock Island, 18 are unique to St. Louis, and 12 are unique to St. Paul. Not counting NONE, the most frequent species unique to Rock Island is UNK, with 5 observations. In St. Louis, the most frequent unique species is swamp privet (FOAC), with 496 observations. For St. Paul, the most frequent unique species is ACNE12, with 390 observations, with black ash (FRNI) the second most frequent with 81 observations.

For the navigation pools, 
...
nrow(N_districts_appearing[N_districts_appearing$Count == 1,])
...
There are 17,639 observations of snags within the UMRS, which is 7.1 percent of all observations. These snags make up a Basal Area of 6,490,402, or about 5.5 percent of the total basal area of the UMRS. Out of all plots in the UMRS, 48.2 contain snags, and a total of 115 plots, or about 0.6 percent, contain exclusively snags. The plot with exclusively snags that has the greatest number of observations is p03244, containing 16 snags in total. The average snag diameter is 19.25 inches, and the distribution is right-skewed with a skewness of 0.95.
