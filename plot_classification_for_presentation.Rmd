---
title: "plot_classification_for_presentation"
...
df <- read_csv("~/Desktop/REU /git/UWL-REU-FPF/clean_data/UMRS_FPF_clean.csv")
``` 
```{r}
plot_abundance <- df %>%
  group_by(PID, TR_SP) %>%
...
#nrow(unique(plots_output[plots_output$Label == "Mixed","Type"]))
