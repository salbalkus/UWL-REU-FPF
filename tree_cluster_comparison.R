...
plots <- left_join(read_csv("clean_data/plots_full.csv"), read_csv("clean_data/plot_classification.csv"), by = "PID")
...
tree <- cutree(cluster_h, best_k)
predict(plots_acsa2, tree)
