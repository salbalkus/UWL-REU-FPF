#This file tests the use of manual feature engineering on clustering as well as the V-measure
#It is considered a failed experiment, as we ended up using silhouette values to select clusters
