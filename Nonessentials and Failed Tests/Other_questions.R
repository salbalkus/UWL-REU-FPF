#This script answers some more of the general starter questions posed by Molly.
#These answers were not really used, so it is not necessary for the final analysis.
