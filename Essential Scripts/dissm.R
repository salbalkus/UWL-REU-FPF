#This script produces a dissimilarity matrix of a given level 1 class for clustering.
#It is not necessary to reproduce our work, but it was useful for developing and testing our system
...
#IMPORTANT: Filter for the level 1 type for which you want to generate the dissimilarity matrix
