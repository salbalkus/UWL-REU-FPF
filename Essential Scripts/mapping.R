#This script plots an example map of forest type spatial distribution across stand 5 of pool 18
...
#Load raw data plus the plot labels and the full level 2 names
