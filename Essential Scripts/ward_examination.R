#This script examines the outcome of Ward clustering for level 2 classification using PCA and visualization
...
#Load original and level 1 data as well as dissimilarity matrix for SILVER MAPLE (ACSA2)
