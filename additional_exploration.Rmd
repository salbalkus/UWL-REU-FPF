...
qplot(ACSA2_rel_TPA, data = plots, binwidth = 0.01, geom = "boxplot")
qplot(PODE3_rel_TPA, data = plots, binwidth = 0.01, geom = "boxplot")
qplot(SNAG_rel_TPA, data = plots, binwidth = 0.1, geom = "boxplot")
qplot(FRPE_rel_TPA, data = plots, binwidth = 0.01, geom = "boxplot")
qplot(SALIX_rel_TPA, data = plots, binwidth = 0.01, geom = "boxplot")
